...
nappula1.addEventListener("click", function() {
    ...
    document.getElementById("kokopituus").innerText = "In total " + KokoPituus + " characters and " + Valilyonnit + " spaces";
    document.getElementById("pituus1").innerText = "YIn total " + Pituus + " letters";
    if (Pituus !== 0) {
        document.getElementById("vastaus1").innerText = "Letters:" + LastSort(Listasi);
        document.getElementById("isotpituus").innerText = "In total " + IsotPituus + " uppercase letters"
        if (IsotPituus !== 0) {
        document.getElementById("isotkirjaimet").innerText = "Uppercase letters:" + LastSort(IsotListasi)
        } else document.getElementById("isotkirjaimet").innerText = ""
        document.getElementById("pienetpituus").innerText = "In total " + PienetPituus + " lowercase letters"
        if (PienetPituus !== 0) {
        document.getElementById("pienetkirjaimet").innerText = "Lowercase letters:" + LastSort(PienetListasi)
    ...
    document.getElementById("pituus2").innerText = "In total " + Pituus2 + " numbers"
    if (Pituus2 !== 0) {
    document.getElementById("vastaus2").innerText = "Numbers:" + LastSort(NumeroLista)
    ...
    document.getElementById("pituus3").innerText = "In total " + Pituus3 + " other characters";
    if (Pituus3 !== 0) {
    document.getElementById("vastaus3").innerText = "Other characters:" + LastSort(array1);
    ...
    document.getElementById("sanamaara").innerText = "In total " + SanaMaara + " words";
    if (SanaMaara !== 0) {        
    document.getElementById("erisanat").innerText = "In total " + EriSanat + " different words";
